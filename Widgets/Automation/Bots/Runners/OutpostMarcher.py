...
MODULE_NAME = "Outpost Marcher"
MODULE_ICON = "Textures\\Skill_Icons\\[372] - Gladiator's Defense.jpg"

# =============================================================================
# region BOT SETTINGS
# =============================================================================
class BotSettings:
    BOT_NAME = "Outpost Marcher"
...
bot = Botting(BotSettings.BOT_NAME,
            ...
            upkeep_birthday_cupcake_active=False,
...
TEXTURE = os.path.join(Py4GW.Console.get_projects_path(), "Textures", "Skill_Icons", "[372] - Gladiator's Defense.jpg")
