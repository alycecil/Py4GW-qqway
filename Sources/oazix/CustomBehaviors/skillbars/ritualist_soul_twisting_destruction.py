...
from Sources.oazix.CustomBehaviors.skills.ritualist.destruction_utility import DestructionUtility
...
class RitualistSoulTwisting_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self, event_bus: EventBus):
        ...
        self.DestructionUtility: CustomSkillUtilityBase = DestructionUtility(event_bus=self.event_bus, current_build=in_game_build)

        # allow other soul twisting
    ...
    def skills_required_in_behavior(self) -> list[CustomSkill]:
        return [
            ...
            self.DestructionUtility.custom_skill,
        ]
