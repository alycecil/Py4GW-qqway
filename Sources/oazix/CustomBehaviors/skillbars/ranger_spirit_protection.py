...
from Sources.oazix.CustomBehaviors.skills.ranger.oath_shot_protective_spirit_utility import OathShotProtectiveSpiritUtility
...
class RangerProtectiveSpirit_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self, event_bus: EventBus):
        ...
        self.shelter_utility: CustomSkillUtilityBase = OathShotProtectiveSpiritUtility(
        ...
        self.union_utility: CustomSkillUtilityBase = OathShotProtectiveSpiritUtility(
            event_bus=self.event_bus,
        ...
        self.displacement_utility: CustomSkillUtilityBase = OathShotProtectiveSpiritUtility(
            event_bus=self.event_bus,
        ...
        self.edge_of_extinction_utility: CustomSkillUtilityBase = OathShotProtectiveSpiritUtility(
            event_bus=self.event_bus,
            skill=CustomSkill("Edge_of_Extinction"),
            current_build=in_game_build,
            score_definition=ScoreStaticDefinition(63),
            owned_spirit_model_id=SpiritModelID.EDGE_OF_EXTINCTION
        )

        self.oath_shot_utility: CustomSkillUtilityBase = RawSimpleAttackUtility(
            event_bus=self.event_bus,
            skill=CustomSkill("Oath_Shot"),
            current_build=in_game_build,
        ...
        self.asuran_scan_utility: CustomSkillUtilityBase = PreparationUtility(
            event_bus=self.event_bus,
            prep_skill=CustomSkill("Asuran_Scan"),
            target_utilities=[self.oath_shot_utility],
            current_build=in_game_build,
            score_definition=ScoreStaticDefinition(55),
            mana_required_to_cast=16,
            allowed_states=[BehaviorState.IN_AGGRO]
        )
        ...
        self.serpents_quickness_prep_utility: CustomSkillUtilityBase = PreparationUtility(
            ...
            target_utilities=[self.displacement_utility, self.union_utility, self.shelter_utility, self.oath_shot_utility, self.edge_of_extinction_utility],
            current_build=in_game_build,
        ...
        self.dwarven_stability_utility: CustomSkillUtilityBase = PreparationUtility(
            event_bus=self.event_bus,
            prep_skill=CustomSkill("Dwarven_Stability"),
            target_utilities=[self.serpents_quickness_prep_utility],
            current_build=in_game_build,
    ...
    def custom_skills_in_behavior(self) -> list[CustomSkillUtilityBase]:
        return [
            ...
            self.asuran_scan_utility,
            self.oath_shot_utility
        ]
    ...
    def skills_required_in_behavior(self) -> list[CustomSkill]:
        return [
            self.oath_shot_utility.custom_skill,
