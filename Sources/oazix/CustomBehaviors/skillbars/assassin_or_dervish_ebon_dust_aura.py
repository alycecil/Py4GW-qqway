...
class EbonDust_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self, event_bus: EventBus):
        ...
        self.Ebon_Dust_Aura_Utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(event_bus=self.event_bus, skill=CustomSkill("Ebon_Dust_Aura"),
    ...
    def skills_required_in_behavior(self) -> list[CustomSkill]:
        return [
            ...
            self.Ebon_Dust_Aura_Utility.custom_skill,
        ]