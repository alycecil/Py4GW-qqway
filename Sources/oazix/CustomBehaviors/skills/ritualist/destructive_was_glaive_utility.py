...
class DestructiveWasGlaiveUtility(CustomSkillUtilityBase):
    ...
    def __init__(self,
                ...
                score_definition: ScorePerAgentQuantityDefinition = ScorePerAgentQuantityDefinition(lambda enemy_qte: 90 if enemy_qte >= 4 else 71 if enemy_qte >= 3 else 45 if enemy_qte >= 2 else 15 if enemy_qte >= 1 else 10),
        ) -> None:
