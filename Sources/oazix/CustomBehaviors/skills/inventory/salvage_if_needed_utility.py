...
class SalvageIfNeededUtility(CustomSkillUtilityBase):
    ...
    def salvage_something(self) -> bool:
        ...
        for item_id in inventory_item_ids:
            ...
            if action_for_item == InventoryMode.SALVAGE:
                print(f"I want to salvage {self.describe_item(item_instance)}")
                return True
    ...
    def _evaluate(self, current_state: BehaviorState, previously_attempted_skills: list[CustomSkill]) -> float | None:
        ...
        if self.inventory_utils.has_salvage_kits():
    ...
    def customized_debug_ui(self, current_state: BehaviorState) -> None:
        ...
        if PyImGui.collapsing_header("View Inventory", PyImGui.TreeNodeFlags.DefaultOpen):
