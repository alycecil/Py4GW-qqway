...
class ImbueHealthUtility(CustomSkillUtilityBase):
    ...
    def __init__(
        ...
        self.add_plugin_option(lambda x: RawNumberOption(x.custom_skill, "require_hp_higher_than_percent", default_value=0.50))
        self.add_plugin_option(lambda x: RawBooleanOption(x.custom_skill, "require_aura_of_restoration", default_value=False))
        self.add_plugin_option(lambda x: RawBooleanOption(x.custom_skill, "require_life_attunement", default_value=False))
