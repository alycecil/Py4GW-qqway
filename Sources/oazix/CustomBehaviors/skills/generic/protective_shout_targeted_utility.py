...
class ProtectiveShoutTargetedUtility(CustomSkillUtilityBase):
    def __init__(self,
        event_bus: EventBus,
        skill: CustomSkill,
    ...
    def _get_targets(self):
        targets: list[
            ...
            condition=lambda agent_id: Agent.GetHealth(agent_id) < self.allies_health_less_than_percent
                                       and not custom_behavior_helpers.Resources.is_ally_under_specific_effect(agent_id,
    ...
    def _execute(self, state: BehaviorState) -> Generator[Any, None, BehaviorResult]:
        ...
        result = yield from custom_behavior_helpers.Actions.cast_skill_to_target(self.custom_skill, targets[0].agent_id)
        return result