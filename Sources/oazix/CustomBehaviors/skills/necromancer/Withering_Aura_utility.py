...
class Withering_Aura_Utility(CustomSkillUtilityBase):
    ...
    def __init__(self,
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Withering_Aura"),
    ...
    def _get_lock_key(self, agent_id: int) -> str:
        return f"Withering_Aura_{agent_id}"
    ...
    def _get_target(self) -> int | None:
        ...
        if self.should_target_ebon_vanguard_assassin:
            ...
            if npc_agent_id != None and npc_agent_id != 0 and not Agent.IsEnchanted(npc_agent_id):
                return npc_agent_id
