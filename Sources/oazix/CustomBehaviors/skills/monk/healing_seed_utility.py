...
class HealingSeedUtility(CustomSkillUtilityBase):
    LOCK_KEY = "HealingSeed"
    def __init__(self,
        event_bus: EventBus,
        current_build: list[CustomSkill],
        score_definition: ScorePerHealthGravityDefinition = ScorePerHealthGravityDefinition(6.5),
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Healing_Seed"),
    ...
    def _get_targets(self) -> list[custom_behavior_helpers.SortableAgentData]:
        ...
        targets: list[custom_behavior_helpers.SortableAgentData] = custom_behavior_helpers.Targets.get_all_possible_allies_ordered_by_priority_raw(
            ...
            condition=lambda agent_id: Agent.GetHealth(agent_id) < 0.9 and self.get_plugin_targeting_modifiers_filtering_predicate_all()(agent_id),
