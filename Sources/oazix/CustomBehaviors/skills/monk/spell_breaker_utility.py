...
class SpellBreakerUtility(CustomSkillUtilityBase):
    ...
    def __init__(self,
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Spell_Breaker"),
    ...
    def _get_lock_key(self, agent_id: int) -> str:
        return f"spell_breaker_{agent_id}"
    ...
    def _execute(self, state: BehaviorState) -> Generator[Any, None, BehaviorResult]:
        ...
        if not CustomBehaviorParty().get_shared_lock_manager().try_aquire_lock(self._get_lock_key(target), 15):
            yield
