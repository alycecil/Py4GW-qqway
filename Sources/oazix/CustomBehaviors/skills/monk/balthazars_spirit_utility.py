...
class Balthazars_Spirit_Utility(CustomSkillUtilityBase):
    def __init__(self,
        event_bus: EventBus,
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Balthazars_Spirit"),
    ...
    def _get_target(self) -> int | None:
        ...
        targets = custom_behavior_helpers.Targets.get_all_possible_allies_ordered_by_priority_raw(
                ...
                condition=lambda agent_id: self.get_plugin_targeting_modifiers_filtering_predicate_all()(agent_id),
