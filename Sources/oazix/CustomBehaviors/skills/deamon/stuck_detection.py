...
class StuckDetectionUtility(CustomSkillUtilityBase):
    def __init__(self, event_bus: EventBus, current_build: list[CustomSkill], threshold: int = 80) -> None:
        ...
        self.throttle_timer_aggro = ThrottledTimer(18_000)  # 12 seconds for IN_AGGRO
        self.throttle_timer_non_aggro = ThrottledTimer(15_000)  # 5 seconds for CLOSE_TO_AGGRO and FAR_FROM_AGGRO
