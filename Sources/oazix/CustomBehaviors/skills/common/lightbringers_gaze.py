...
class LightbringersGazeUtility(CustomSkillUtilityBase):
    """
    ...
    def __init__(self,
        ...
        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Lightbringers_Gaze"),
    ...
    def _get_lock_key(self, agent_id: int) -> str:
        return f"Lightbringers_Gaze_{agent_id}"
