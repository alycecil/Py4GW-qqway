...
class Heal_as_One_Utility(CustomSkillUtilityBase):
    def __init__(self,
        event_bus: EventBus,
        ...
        self.throttle_timer : ThrottledTimer = ThrottledTimer(15000)

    @override
    def _evaluate(self, current_state: BehaviorState, previously_attempted_skills: list[CustomSkill]) -> float | None:
        if self.throttle_timer.IsExpired():
        ...
        if Utils.Distance(Player.GetXY(), Agent.GetXY(pet_id)) > Range.Spirit.value:
            return None
