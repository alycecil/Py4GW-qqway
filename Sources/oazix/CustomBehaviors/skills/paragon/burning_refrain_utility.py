...
from Sources.oazix.CustomBehaviors.skills.plugins.targeting_modifiers.should_target_pets_with_weapon_spell import \
    ShouldTargetPetsWithWeaponSpell


class Burning_RefrainUtility(CustomSkillUtilityBase):
    ...
    def __init__(self,
                 ...
                 allowed_states: list[BehaviorState] = [BehaviorState.IN_AGGRO, BehaviorState.CLOSE_TO_AGGRO, BehaviorState.IDLE]
                 ) -> None:

        super().__init__(
            event_bus=event_bus,
            skill=CustomSkill("Burning_Refrain"),
        ...
        self.add_plugin_targetting_modifier(lambda x: BuffConfigurator(event_bus, self.custom_skill,
    ...
    def _execute(self, state: BehaviorState) -> Generator[Any, None, BehaviorResult]:
        ...
        result = yield from custom_behavior_helpers.Actions.cast_skill_to_target(self.custom_skill,
