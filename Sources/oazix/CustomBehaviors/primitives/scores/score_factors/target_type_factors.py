...
class target_type_factor_combatant(target_type_factor_DefaultScoreFactors):

    def __init__(
            self,
            caster_factor: float = -30.0,
            non_caster_factor: float = 10.0,
            is_attacking: float = 30.0,
            is_not_attacking: float = -10.0,
    ):
        super().__init__()
        self.caster_factor: float = caster_factor
        self.non_caster_factor: float = non_caster_factor
